...
public class SubModuleDtos {
    ...
    private String trainingCenterLabel;
    ...
    public String getTrainingCenterLabel() { return trainingCenterLabel; }
    public void setTrainingCenterLabel(String trainingCenterLabel) { this.trainingCenterLabel = trainingCenterLabel; }
